...
*UaaControllerApi* | [**oauth_token**](docs/UaaControllerApi.md#oauth_token) | **POST** /api/uaa/oauth/token | Obtain JWT token using API token
...
## Documentation For Models
 ...
 - [OauthToken200Response](docs/OauthToken200Response.md)
