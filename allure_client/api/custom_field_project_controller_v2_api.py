...
class CustomFieldProjectControllerV2Api:
    ...
    @validate_call
    def project_project_id_cf_cf_id_patch(
        self,
        ...
        """project_project_id_cf_cf_id_patch
        ...
        _param = self._project_project_id_cf_cf_id_patch_serialize(
    ...
    @validate_call
    def project_project_id_cf_cf_id_patch_with_http_info(
        self,
        project_id: StrictInt,
        cf_id: StrictInt,
        custom_field_project_patch_dto: CustomFieldProjectPatchDto,
    ...
    @validate_call
    def project_project_id_cf_cf_id_patch_without_preload_content(
        self,
        project_id: StrictInt,
        cf_id: StrictInt,
        custom_field_project_patch_dto: CustomFieldProjectPatchDto,
    ...
    def _project_project_id_cf_cf_id_patch_serialize(
        self,
        project_id,
        cf_id,
    ...
    def project_project_id_cf_get(
        ...
        _param = self._project_project_id_cf_get_serialize(
            project_id=project_id,
            query=query,
            page=page,
            size=size,
    ...
    @validate_call
    def project_project_id_cf_get_with_http_info(
        self,
        project_id: StrictInt,
        query: Optional[StrictStr] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
    ...
    @validate_call
    def project_project_id_cf_get_without_preload_content(
        self,
        project_id: StrictInt,
        query: Optional[StrictStr] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
    ...
    def _project_project_id_cf_get_serialize(
        self,
        project_id,
        query,
        page,
