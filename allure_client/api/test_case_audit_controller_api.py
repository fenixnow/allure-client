...
class TestCaseAuditControllerApi:
    ...
    def testcase_audit_get(
        ...
        _param = self._testcase_audit_get_serialize(
    ...
    @validate_call
    def testcase_audit_get_with_http_info(
        self,
        test_case_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageTestCaseAuditLogEntryDto]:
        """Find audit log for test case
    ...
    @validate_call
    def testcase_audit_get_without_preload_content(
        self,
        test_case_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _testcase_audit_get_serialize(
        self,
        test_case_id,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/testcase/audit',
