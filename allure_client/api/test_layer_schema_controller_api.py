...
class TestLayerSchemaControllerApi:
    ...
    def testlayerschema_get(
        ...
        _param = self._testlayerschema_get_serialize(
    ...
    @validate_call
    def testlayerschema_get_with_http_info(
        self,
        project_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    @validate_call
    def testlayerschema_get_without_preload_content(
        self,
        project_id: StrictInt,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
        size: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="The size of the page to be returned")] = None,
    ...
    def _testlayerschema_get_serialize(
        self,
        project_id,
        page,
        size,
    ...
    def testlayerschema_id_delete(
        ...
        _param = self._testlayerschema_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def testlayerschema_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def testlayerschema_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _testlayerschema_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def testlayerschema_id_get(
        ...
        _param = self._testlayerschema_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def testlayerschema_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def testlayerschema_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _testlayerschema_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def testlayerschema_id_patch(
        ...
        _param = self._testlayerschema_id_patch_serialize(
            id=id,
    ...
    @validate_call
    def testlayerschema_id_patch_with_http_info(
        self,
        id: StrictInt,
        test_layer_schema_patch_dto: TestLayerSchemaPatchDto,
        _request_timeout: Union[
    ...
    @validate_call
    def testlayerschema_id_patch_without_preload_content(
        self,
        id: StrictInt,
        test_layer_schema_patch_dto: TestLayerSchemaPatchDto,
        _request_timeout: Union[
    ...
    def _testlayerschema_id_patch_serialize(
        self,
        id,
    ...
    def testlayerschema_post(
        ...
        _param = self._testlayerschema_post_serialize(
    ...
    @validate_call
    def testlayerschema_post_with_http_info(
        self,
        test_layer_schema_create_dto: TestLayerSchemaCreateDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def testlayerschema_post_without_preload_content(
        self,
        test_layer_schema_create_dto: TestLayerSchemaCreateDto,
        _request_timeout: Union[
            None,
    ...
    def _testlayerschema_post_serialize(
        self,
