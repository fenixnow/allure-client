...
class StatusControllerApi:
    ...
    def status_id_delete(
        ...
        _param = self._status_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def status_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def status_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _status_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def status_id_get(
        ...
        _param = self._status_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def status_id_get_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def status_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def status_id_patch(
        ...
        _param = self._status_id_patch_serialize(
            id=id,
    ...
    @validate_call
    def status_id_patch_with_http_info(
        self,
        id: StrictInt,
        status_patch_dto: StatusPatchDto,
        _request_timeout: Union[
    ...
    @validate_call
    def status_id_patch_without_preload_content(
        self,
        id: StrictInt,
        status_patch_dto: StatusPatchDto,
        _request_timeout: Union[
    ...
    def _status_id_patch_serialize(
        self,
        id,
        status_patch_dto,
        _request_auth,
    ...
    def status_post(
        ...
        _param = self._status_post_serialize(
    ...
    @validate_call
    def status_post_with_http_info(
        self,
        status_create_dto: StatusCreateDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def status_post_without_preload_content(
        self,
        status_create_dto: StatusCreateDto,
        _request_timeout: Union[
            None,
    ...
    def status_suggest_get(
        ...
        _param = self._status_suggest_get_serialize(
            query=query,
            workflow_id=workflow_id,
            id=id,
            ignore_id=ignore_id,
    ...
    @validate_call
    def status_suggest_get_with_http_info(
        self,
        query: Optional[StrictStr] = None,
        workflow_id: Optional[StrictInt] = None,
        id: Optional[List[StrictInt]] = None,
    ...
    @validate_call
    def status_suggest_get_without_preload_content(
        self,
        query: Optional[StrictStr] = None,
        workflow_id: Optional[StrictInt] = None,
        id: Optional[List[StrictInt]] = None,
    ...
    def _status_suggest_get_serialize(
        self,
        query,
        workflow_id,
        id,
