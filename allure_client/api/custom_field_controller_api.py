...
class CustomFieldControllerApi:
    ...
    def cf_count_usage_get(
        ...
        _param = self._cf_count_usage_get_serialize(
            id=id,
    ...
    @validate_call
    def cf_count_usage_get_with_http_info(
        self,
        id: List[StrictInt],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cf_count_usage_get_without_preload_content(
        self,
        id: List[StrictInt],
        _request_timeout: Union[
            None,
    ...
    def _cf_count_usage_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def cf_get_without_preload_content(
        self,
        project_id: StrictInt,
        query: Optional[StrictStr] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Zero-based page index (0..N)")] = None,
    ...
    def cf_id_archived_post(
        ...
        _param = self._cf_id_archived_post_serialize(
            id=id,
            archived=archived,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def cf_id_archived_post_with_http_info(
        self,
        id: StrictInt,
        archived: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cf_id_archived_post_without_preload_content(
        self,
        id: StrictInt,
        archived: Optional[StrictBool] = None,
        _request_timeout: Union[
    ...
    def _cf_id_archived_post_serialize(
        self,
        id,
        archived,
        _request_auth,
    ...
    def cf_id_delete(
        ...
        _param = self._cf_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cf_id_delete_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cf_id_delete_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def cf_id_get(
        ...
        _param = self._cf_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def cf_id_get_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def cf_id_patch(
        ...
        _param = self._cf_id_patch_serialize(
            id=id,
    ...
    @validate_call
    def cf_id_patch_with_http_info(
        self,
        id: StrictInt,
        custom_field_patch_dto: CustomFieldPatchDto,
        _request_timeout: Union[
    ...
    @validate_call
    def cf_id_patch_without_preload_content(
        self,
        id: StrictInt,
        custom_field_patch_dto: CustomFieldPatchDto,
        _request_timeout: Union[
    ...
    def cf_merge_post(
        ...
        _param = self._cf_merge_post_serialize(
    ...
    @validate_call
    def cf_merge_post_with_http_info(
        self,
        custom_field_merge_dto: CustomFieldMergeDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cf_merge_post_without_preload_content(
        self,
        custom_field_merge_dto: CustomFieldMergeDto,
        _request_timeout: Union[
            None,
    ...
    def cf_post(
        ...
        _param = self._cf_post_serialize(
    ...
    @validate_call
    def cf_post_without_preload_content(
        self,
        custom_field_create_dto: CustomFieldCreateDto,
        _request_timeout: Union[
            None,
    ...
    def cf_suggest_get(
        ...
        _param = self._cf_suggest_get_serialize(
            project_id=project_id,
            query=query,
    ...
    @validate_call
    def cf_suggest_get_with_http_info(
        self,
        project_id: Optional[StrictInt] = None,
        query: Optional[StrictStr] = None,
        exclude_project_id: Optional[List[StrictInt]] = None,
    ...
    @validate_call
    def cf_suggest_get_without_preload_content(
        self,
        project_id: Optional[StrictInt] = None,
        query: Optional[StrictStr] = None,
        exclude_project_id: Optional[List[StrictInt]] = None,
